          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "32px" }}>
            {items.map((option, index) => (
              <div key={index} style={{
                ...
                borderTop: `4px solid ${option.color || 'var(--color-primary)'}`,
                display: "flex",
                ...
                <div style={{
                  ...
                  height: "64px",
                  borderRadius: "50%",
                  background: `${option.color || '#36b37e'}15`,
                  color: option.color || '#36b37e',
                  display: "flex",
                  alignItems: "center",
      ...
      <section style={{ background: "#f8f9fa", padding: "64px 0", borderTop: "1px solid #eee" }}>
        <div className="container">
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            <h2 style={{ fontSize: "2rem", color: "var(--color-primary-dark)", marginBottom: "16px" }}>{profilesTitle}</h2>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "16px" }}>
            {profiles.map((profile, i) => (
              <div key={i} style={{
                ...
                <DynamicIcon name={profile.icon} size={20} className="text-[#36b37e]" />
                {profile.name}
              </div>
            ))}
          </div>
